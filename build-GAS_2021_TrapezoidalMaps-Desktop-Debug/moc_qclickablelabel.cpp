...
#include "../GAS_2021_TrapezoidalMaps/cg3lib/cg3/viewer/widgets/qclickablelabel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QClickableLabel_t, stringdata0) + ofs \
...
void QClickableLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QClickableLabel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QClickableLabel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QClickableLabel::clicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QClickableLabel::staticMetaObject = { {
    &QLabel::staticMetaObject,
    qt_meta_stringdata_QClickableLabel.data,
    qt_meta_data_QClickableLabel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QClickableLabel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QClickableLabel.stringdata0))
